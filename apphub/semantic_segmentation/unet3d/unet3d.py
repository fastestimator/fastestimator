...
def unet3d_3plus(input_size=(288, 288, 160, 1), output_classes=5, channels=32):
    ...
    up5_4 = Conv3D(channels * 2, 2, **conv_config)(UpSampling3D(size=(2, 2, 2))(conv4))
    up5_3 = Conv3D(channels * 2, 2, **conv_config)(conv3)
    down5_2 = Conv3D(channels * 2, 2, **conv_config)(MaxPooling3D(pool_size=(2, 2, 2))(conv2))
    down5_1 = Conv3D(channels * 2, 2, **conv_config)(MaxPooling3D(pool_size=(4, 4, 4))(conv1))
    ...
    up6_4 = Conv3D(channels * 2, 2, **conv_config)(UpSampling3D(size=(4, 4, 4))(conv4))
    up6_3 = Conv3D(channels * 2, 2, **conv_config)(UpSampling3D(size=(2, 2, 2))(conv5))
    up6_2 = Conv3D(channels * 2, 2, **conv_config)(conv2)
    down6_1 = Conv3D(channels * 2, 2, **conv_config)(MaxPooling3D(pool_size=(2, 2, 2))(conv1))
    ...
    up7_4 = Conv3D(channels * 2, 2, **conv_config)(UpSampling3D(size=(8, 8, 8))(conv4))
    up7_3 = Conv3D(channels * 2, 2, **conv_config)(UpSampling3D(size=(4, 4, 4))(conv5))
    up7_2 = Conv3D(channels * 2, 2, **conv_config)(UpSampling3D(size=(2, 2, 2))(conv6))
    down7_1 = Conv3D(channels * 2, 2, **conv_config)(conv1)
    merge7 = concatenate([up7_4, up7_3, up7_2, down7_1], axis=4)
...
def unet3d_3plus_bn_before(input_size=(288, 288, 160, 1), output_classes=5, channels=32):
    inputs = Input(input_size)
    conv_config = {'activation': None, 'padding': 'same', 'kernel_initializer': 'he_normal'}
