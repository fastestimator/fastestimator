...
from fastestimator.op.numpyop.univariate import Minmax, ReadImage, Binarize, ChannelTranspose
...
def get_estimator(epochs=60,
    ...
    pipeline = fe.Pipeline(
        ...
        ops=[
            ...
            ChannelTranspose(inputs="mask", outputs="mask"),
            ChannelTranspose(inputs="box_mask", outputs="box_mask"),
        ])
    # step 2
