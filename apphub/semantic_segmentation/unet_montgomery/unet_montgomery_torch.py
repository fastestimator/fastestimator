...
from fastestimator.op.numpyop import Delete, HorizontalFlip, Minmax, ReadImage, Reshape, Resize, Rotate, Sometimes
...
def get_estimator(epochs=20, batch_size=4, max_steps_per_epoch=None, save_dir=tempfile.mkdtemp(), log_steps=20):
    ...
    # step 3
    traces = [
        ls -l Dice(true_key="mask", pred_key="pred_segment"),
