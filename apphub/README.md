...
* **Stable-Diffusion:** High-Resolution Image Synthesis with Latent Diffusion Models on an NIH chest X-ray dataset. [[paper](https://arxiv.org/abs/2112.10752)][[pytorch code](https://github.com/fastestimator/fastestimator/blob/master/apphub/image_generation/stablediffusion/stablediffusion_torch.py)][[notebook](https://github.com/fastestimator/fastestimator/blob/master/apphub/image_generation/stablediffusion/stablediffusion.ipynb)]
