...
class TestRandomSizedBBoxSafeCrop(unittest.TestCase):
    ...
    def test_input(self):
        safecrop = RandomSizedBBoxSafeCrop(image_in='x', height=self.height, width=self.width)
    ...
    def test_input_image_and_mask(self):
        safecrop = RandomSizedBBoxSafeCrop(image_in='x', mask_in='x_mask', height=self.height, width=self.width)
