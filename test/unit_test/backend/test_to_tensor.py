...
class TestToTensor(unittest.TestCase):
    ...
    def setUpClass(cls):
        ...
        cls.data_tf = {"x": tf.ones((10,15), dtype=tf.float64), "y":[tf.ones((4), dtype=tf.float64), tf.ones((5, 3), dtype=tf.float64)], "z":{"key":tf.ones((2,2), dtype=tf.float64)}}
        cls.data_torch = {"x": torch.ones((10,15), dtype=torch.float64), "y":[torch.ones((4), dtype=torch.float64), torch.ones((5, 3), dtype=torch.float64)], "z":{"key":torch.ones((2,2), dtype=torch.float64)}}
