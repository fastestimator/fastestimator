...
filepath=${path_apphub}'/image_classification/lenet_cifar10_adversarial/' 
fname='lenet_cifar10_adversarial' 
...
nb_train_info='-p epochs 2 -p batch_size 2 -p steps_per_epoch 10 -p validation_steps 5 -p num_test_samples 10' #notebook parameters
