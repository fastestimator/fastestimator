...
filepath=${path_apphub}'/image_generation/dcgan_mnist/' 
fname='dcgan_mnist' 
...
nb_train_info='-p epochs 2 -p batch_size 2 -p steps_per_epoch 10 -p validation_steps 5 -p saved_model_path gen_epoch_0_step_10.h5' 
