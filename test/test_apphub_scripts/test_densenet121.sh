...
filepath=${path_apphub}'/image_classification/densenet121_cifar10/' 
fname='densenet121_cifar10' 
...
nb_train_info='-p epochs 2 -p batch_size 2 -p steps_per_epoch 10 -p validation_steps 5' 
