...
if __name__ == "__main__":
    ...
    example_name = "uncertainty_loss_cub200"
    source_dir = os.path.join(apphub_path, "multi_task_learning", "uncertainty_weighted_loss")
    ...
    train_info = "-p epochs 2 -p batch_size 2 -p steps_per_epoch 10 -p validation_steps 5"
