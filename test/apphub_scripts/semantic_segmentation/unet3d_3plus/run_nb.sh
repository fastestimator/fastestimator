...
example_name="unet3d_3plus"

# The training arguments
# 1. Usually we set the epochs:2, batch_size:2, train_steps_per_epoch:2
# 2. The expression for the above setup is "-p epochs 2 -p batch_size 2 -p train_steps_per_epoch 2"
...
train_info=(-p epochs 2 -p batch_size 4 -p train_steps_per_epoch 2 -p eval_steps_per_epoch 2 -p height 32 -p width 32 -p depth 16)
