...
train_info=(-p epochs 2 -p train_steps_per_epoch 2 -p eval_steps_per_epoch 2 -p batch_size 4 -p context_len 64 -p num_blocks 1 -p em_dim 64 -p ffwd_dim 256 -p num_heads 4)
