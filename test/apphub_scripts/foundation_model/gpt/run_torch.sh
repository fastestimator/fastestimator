...
train_info=(--epochs 2 --train_steps_per_epoch 2 --eval_steps_per_epoch 2 --batch_size 4 --context_len 64 --num_blocks 1 --em_dim 64 --ffwd_dim 256 --num_heads 4 --warmup False)
