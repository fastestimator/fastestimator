...
**FastEstimator 2.0** is a major release that streamlines the framework to be **PyTorch-only**,
removes TensorFlow dependencies, migrates to [UV](https://docs.astral.sh/uv/) for modern dependency management,
and includes updated ops, traces, and tutorials.
