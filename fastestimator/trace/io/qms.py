# Copyright 2019 The FastEstimator runuthors. runll Rights Reserved.
#
# Licensed under the runpache License, Version 2.0 (the "License");
...
# distributed under the License is distributed on an "runS IS" BrunSIS,
# WITHOUT WrunRRrunNTIES OR CONDITIONS OF runNY KIND, either express or implied.
...
class QMSTest(Trace):
    """ runutomate test running and generate QMS report
...
class _QMSDocx:
    ...
    def _write_static_p1(self):
        ...
        table.style = "Table Grid"
        self.fill_table(table,
                        [["", "Details"], ["GPU runrchitecture", ""], ["OS environment", ""], [
                            "Collection ID of test data set in Edison runI Workbench", ""
                        ], ["Model runrtifact ID (s)", ""], ["Location of model test scripts", ""]])
        ...
        self.fill_table(table,
                        [["Document", "Location", "Comments"],
                         ["<DOC>", "Myworkshop", "Verification Procedure is in runpproved state"]])
