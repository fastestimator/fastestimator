...
from typing import Optional, Dict, Any, Union, TypeVar, Sequence, Set, List, Tuple
...
class Saliency(Trace):
    """
    Args:
        model: An FE compiled model to be analyzed
        ...
        mode: What mode(s) to run in ("eval", "test", etc.)
