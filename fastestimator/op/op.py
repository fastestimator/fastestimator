...
def _get_inputs_by_keys(store: Mapping[str, Any], input_keys: List[Union[str, Callable]]) -> Any:
    return [store[key] if not isinstance(key, Callable) else key() for key in input_keys]
