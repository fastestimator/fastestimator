...
@traceable()
class RandomCropFromBorders(MultiVariateAlbumentation):
    ...
    Args:
        ...
        crop_left: Randomly crop left border of image.Float value in the range (0.0, 1.0).
        crop_right: Randomly crop right border of image.Float value in the range (0.0, 1.0).
        crop_top: Randomly crop top border of image.Float value in the range (0.0, 1.0).
        crop_bottom: Randomly crop bottom border of image.Float value in the range (0.0, 1.0).
