...
from albumentations.augmentations import BBoxSafeRandomCrop as BBoxSafeRandomCropAlb
...
@traceable()
class BBoxSafeRandomCrop(MultiVariateAlbumentation):
    ...
    Args:
        ...
        erosion_rate: erosion rate applied on input image height before crop.Float value in the range (0.0, 1.0).
