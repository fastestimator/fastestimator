...
class MixUpBatch(TensorOp):
    ...
    def forward(self, data, state):
        ...
        if self.sharedbeta:
            ...
            # this removes duplicate pairs in the batch incase beta distribution is symmetric
            # out = 0.9*x1 + 0.1*x2
            # out = 0.1*x2 + 0.9*x1
