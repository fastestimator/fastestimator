...
class MixUpLoss(TensorOp):
    ...
    """
    def __init__(self, loss, lam=None, y_true=None, y_pred=None, outputs=None, mode=None, framework='tf'):
    ...
    def forward(self, data, state):
        ...
        if tf.is_tensor(true):
            ...
            loss1 = self.loss_obj(pred, true.long())
            loss2 = self.loss_obj(pred, torch.roll(true.long(), shifts=1, dims=0))
