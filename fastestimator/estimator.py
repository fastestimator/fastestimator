...
def _verify_dependency_versions() -> None:
    ...
    if torch.__version__ not in ('2.4.1', '2.4.1+cpu', '2.4.1+cu118'):
        warn(f"Expected PyTorch version 2.4.1 but found {torch.__version__}. The framework may not work as expected.")
