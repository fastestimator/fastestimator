...
class Estimator:
    ...
    def _prepare_traces(self):
        ...
        self.traces.append(Logger(log_names=monitor_names, loss_names=loss_keys))
        return traces
    ...
    def _run_epoch(self):
        ...
        loader = self.pipeline.get_loader(mode=self.system.mode, epoch=self.system.epoch_idx)
