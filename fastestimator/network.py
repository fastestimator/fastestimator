...
class BaseNetwork:
    ...
    def load_epoch(self, mode: str, epoch: int, output_keys: Optional[Set[str]] = None, warmup: bool = False) -> None:
        ...
        Args:
            ...
            output_keys: What keys are considered to move from the GPU back to the CPU after executing a step.
...
def build(model_fn: Callable[[], Union[tf.keras.Model, torch.nn.Module]],
    ...
    Args:
        ...
        model_names: Name(s) of the model(s) that will be used for logging purpose. If None, a name will be
