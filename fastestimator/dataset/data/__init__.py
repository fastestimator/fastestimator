...
__getattr__, __dir__, __all__ = lazy.attach(__name__,
                                            submodules={'breast_cancer', 'cifair10', 'cifair100', 'cifar10',
                                                        ...
                                                        'medmnist', 'wikitext_103', 'unnatural_instructions'}
                                            )

if TYPE_CHECKING:
    from fastestimator.dataset.data import breast_cancer, cifair10, cifair100, cifar10, cifar100, cub200, em_3d, \
        food101, horse2zebra, imdb_review, medmnist, mendeley, mitmovie_ner, mnist, montgomery, mscoco, nih_chestxray, \
        omniglot, pascal_voc, penn_treebank, shakespeare, skl_digits, svhn, svhn_cropped, tednmt, \
        unnatural_instructions, usps, wikitext_103
